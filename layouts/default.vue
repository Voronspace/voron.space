      ...
      >
        ...
        <div class="customCheckbox">
          <input
            ...
            required
          />
          <label for="agreeTermsCity">Даю согласие на <a href="https://voron.store/legal/personal-data/" target="_blank">обработку персональных данных</a></label>
        </div>
                  ...
                  <nav class="sidebarMenu-main">
                    <ul>
                      ...
                      <li>
                        ...
                        <a
                          :href="`https://voron.space/${$utm(true)}`"
                        >Каршеринг</a
                        >
                      ...
                      <li>
                        <a
                          :href="`https://voron.space/delivery/${$utm(true)}`"
          ...
          "
              ...
              <div class="pageFooter-publicLinks footer-social-block__ footer-social-reset">
                <a
                    ...
                    target="_blank"
                    href="https://www.instagram.com/voron.store/"
                >
                </a>
                <a
                    class="pageFooter-publicLink footer-social-icon"
                    href="https://vk.com/voron.store"
                    target="_blank"
                >
                  <i class="fab fa-vk"></i>
                </a>
                ...
                <a
                    class="pageFooter-publicLink footer-social-icon"
                    href="https://www.youtube.com/channel/UCbViwBlU6qTIXFykMdO-H2g"
                    target="_blank"
                >
