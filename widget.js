(function() {
    ...
    const css = `
        ...
        @media (max-width: 480px) {
            ...
            /* На мобильных кнопку можно переместить или скрыть, если окно открыто. 
               Оставим её поверх, чтобы можно было закрыть. */
            .voron-launcher-btn.opened {
                bottom: 20px;
                right: 20px;
                background: rgba(255, 255, 255, 0.1); /* Более прозрачная кнопка закрытия на мобильном */
            }
        }
    `;
