                ...
                <div class="contactsPage-table">
                  ...
                  >
                    ...
                    <address class="contactsPage-address" style="margin-top: 0;">
                      ...
                      БЦ "Омега Плаза"
                      <br />
                      ООО "Ворон" ОГРН 1187746508069 ИНН 7726432236
                    </address>
                  </div>
                </div>
                ...
                >
                  ...
                  <div class="customCheckbox">
                    <input
                      ...
                      required
                    />
                    <label for="agreeTerms">Даю согласие на <a href="https://voron.club/legal/personal-data/" target="_blank">обработку персональных данных</a></label>
                  </div>
