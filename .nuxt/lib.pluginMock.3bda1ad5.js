...
export default ({ app }, inject) => {
   ...
   */
  const options = JSON.parse('{"id":"45891591","webvisor":true,"clickmap":true,"useCDN":false,"trackLinks":true,"accurateTrackBounce":true,"debug":false,"noJS":false,"disabled":false,"ut":"noindex","trackHash":true}');
  const { router } = app;
